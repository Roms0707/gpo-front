          ...
          <div className="px-4 lg:px-8 -mt-20 relative z-10">
            <div className="max-w-7xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-8">
                <div className="bg-dark-200/80 backdrop-blur-sm rounded-2xl p-6 lg:p-8 border border-gray-800/50">
                ...
                <div className="space-y-4">
                  <div className="bg-dark-200 rounded-xl border border-gray-800/50 overflow-hidden">
                    <div className="bg-red-600/20 px-4 py-3 flex items-center gap-3">
                      <span className="w-6 h-6 rounded-full bg-red-500 text-white text-sm font-bold flex items-center justify-center">
                        1
                      </span>
                      <span className="text-white font-medium">{t('store.userInformation')}</span>
                    </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <button
                              ...
                              className="w-full bg-dark-100 border border-gray-700 rounded-lg px-4 py-3 text-left flex items-center justify-between focus:outline-none focus:border-primary-500 transition-colors"
                            >
                              <span className={selectedServer ? 'text-white' : 'text-gray-500'}>
                                {selectedServer || t('store.selectServerPlaceholder')}
                              </span>
                              <ChevronDown className={`w-5 h-5 text-gray-400 transition-transform ${isServerDropdownOpen ? 'rotate-180' : ''}`} />
                            </button>
                              ...
                              <div className="absolute z-20 w-full mt-1 bg-dark-100 border border-gray-700 rounded-lg shadow-xl overflow-hidden">
                                {SERVERS.map((server) => (
                                  <button
                                    ...
                                    className="w-full px-4 py-3 text-left text-white hover:bg-dark-200 transition-colors flex items-center justify-between"
                                  >
                                    <span>{server}</span>
                  ...
                  <div className="bg-dark-200 rounded-xl border border-gray-800/50 overflow-hidden">
                    <div className="bg-red-600/20 px-4 py-3 flex items-center gap-3">
                      ...
                      <span className="text-white font-medium">{t('store.selectAmount')}</span>
                    </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        {voucherOptions.map((option) => {
                          ...
                          return (
                            ...
                            >
                              {isSelected && (
                                <div className="absolute top-2 left-2 w-5 h-5 rounded bg-red-500 flex items-center justify-center">
                  ...
                  <div className="bg-dark-200 rounded-xl border border-gray-800/50 overflow-hidden">
                    <div className="bg-red-600/20 px-4 py-3 flex items-center gap-3">
                      ...
                      <span className="text-white font-medium">{t('store.enterCouponCode')}</span>
                    </div>
