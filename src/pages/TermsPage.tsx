...
const TermsPage: React.FC = () => {
  return (
    ...
    >
      <p>
        Bienvenue sur Orange Arena. Les présentes Conditions Générales d'Utilisation régissent votre accès et utilisation de notre plateforme. En utilisant nos services, vous acceptez d'être lié par ces conditions.
      </p>

      <h2>1. Définitions</h2>
      <ul>
        <li><strong>"Plateforme"</strong> désigne le site web Orange Arena accessible à l'adresse www.orangearena.tn et toutes ses sous-sections.</li>
      ...
      <p>
        L'Utilisateur est seul responsable de la préservation de la confidentialité de son identifiant et de son mot de passe, ainsi que de toutes les activités qui se déroulent sur son Compte. L'Utilisateur doit immédiatement informer Orange Arena de toute utilisation non autorisée de son Compte.
      </p>
      ...
      <p>
        Les Participants sont responsables de leur propre matériel et connexion internet. Orange Arena ne pourra être tenue responsable des problèmes techniques individuels rencontrés par les Participants.
      </p>
      
      <h3>3.4 Droit à l'image</h3>
      <p>
        En participant à un Tournoi, le Participant autorise Orange Arena à utiliser son nom, son pseudonyme et son image pour la promotion des Tournois et de la Plateforme, sans rémunération supplémentaire.
      </p>

      <h2>4. Récompenses et Gains</h2>
      <h3>4.1 Attribution des récompenses</h3>
      <p>
        Les récompenses sont attribuées conformément aux règles spécifiques de chaque Tournoi. Orange Arena se réserve le droit de vérifier l'identité et l'éligibilité des gagnants avant de décerner les prix.
      </p>
      ...
      <p>
        Il appartient aux gagnants de déclarer leurs gains conformément à la législation fiscale en vigueur dans leur pays de résidence. Orange Arena n'assume aucune responsabilité quant aux obligations fiscales des Participants.
      </p>

      <h2>5. Propriété intellectuelle</h2>
      <h3>5.1 Contenu de la Plateforme</h3>
      <p>
        L'ensemble du Contenu présent sur la Plateforme (textes, images, logos, codes, etc.) est protégé par des droits de propriété intellectuelle et appartient à Orange Arena ou à ses partenaires. Toute reproduction non autorisée est interdite.
      </p>
      
      <h3>5.2 Licence limitée</h3>
      <p>
        Orange Arena accorde à l'Utilisateur une licence limitée, non exclusive et non transférable pour accéder et utiliser la Plateforme à des fins personnelles et non commerciales.
      </p>
      ...
      <p>
        Orange Arena s'efforce d'assurer au mieux l'accès et le fonctionnement de la Plateforme, mais ne peut garantir que son fonctionnement sera ininterrompu et sans erreur. Orange Arena ne saurait être tenue responsable des dommages directs ou indirects résultant de l'utilisation de la Plateforme.
      </p>

      <h2>8. Modification des services et des conditions</h2>
      <p>
        Orange Arena se réserve le droit de modifier, suspendre ou interrompre tout ou partie des services proposés sur la Plateforme, ainsi que de modifier les présentes Conditions Générales d'Utilisation à tout moment. Les Utilisateurs seront informés de toute modification substantielle.
      </p>

      <h2>9. Résiliation</h2>
      <p>
        Orange Arena se réserve le droit de suspendre ou de résilier l'accès d'un Utilisateur à la Plateforme en cas de violation des présentes Conditions Générales d'Utilisation, sans préavis ni indemnité.
      </p>
      ...
      <h2>11. Contact</h2>
      <p>
        Pour toute question relative aux présentes Conditions Générales d'Utilisation, vous pouvez contacter Orange Arena à l'adresse email suivante : legal@esportzone.com.
      </p>
    </LegalContentLayout>
  );
};
