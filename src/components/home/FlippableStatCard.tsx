...
export const FlippableStatCard: React.FC<FlippableStatCardProps> = ({
  ...
  return (
    <div
      className={`relative perspective-1000 cursor-pointer group transition-all duration-500 ${
    ...
    >
      ...
      >
        ...
        >
          <div className="relative h-full px-4 py-4 sm:px-6 sm:py-5">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full">
              ...
              <span className="text-[10px] sm:text-xs font-medium tracking-widest uppercase text-gray-400 text-center">
                {label}
              </span>
            </div>
          </div>
        ...
        >
          <div className="relative h-full px-4 py-4 sm:px-6 sm:py-5 flex items-center justify-center">
            <div
            ...
            />
            <span
              className="text-xs sm:text-sm font-semibold tracking-wide text-center uppercase"
              style={{
                color: accentColor,
