...
export const HeroCarousel: React.FC<HeroCarouselProps> = ({
  ...
  if (isLoading) {
    return (
      <div className="relative min-h-[70vh] sm:min-h-[80vh] md:min-h-[88vh] lg:min-h-[92vh] xl:min-h-[95vh] 2xl:min-h-[98vh] bg-dark-100 flex items-center justify-center">
  ...
  return (
    <div
      className="relative min-h-[70vh] sm:min-h-[80vh] md:min-h-[88vh] lg:min-h-[92vh] xl:min-h-[95vh] 2xl:min-h-[98vh] overflow-hidden"
    ...
    >
      ...
      >
        {slides.map((slide, index) => (
          <div
            key={slide.id}
            className="relative min-h-[70vh] sm:min-h-[80vh] md:min-h-[88vh] lg:min-h-[92vh] xl:min-h-[95vh] 2xl:min-h-[98vh] flex-shrink-0"
